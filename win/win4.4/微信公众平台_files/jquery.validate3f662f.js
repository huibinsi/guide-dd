define("common/wx/mpEditor/editor.js",["widget/ueditor_new/themes/default/ueditor.css","widget/ueditor_new/themes/default/css/ueditor.css","widget/tooltip.css","common/wx/Cgi.js","tpl/mpEditor/layout.html.js","common/wx/mpEditor/plugin/filter.js","common/wx/mpEditor/contextmenu.js","common/wx/mpEditor/editor_options.js","common/wx/mpEditor/plugin/popup.js","common/wx/mpEditor/plugin/remoteimg.js","common/wx/mpEditor/plugin/filterPlugin.js","common/wx/mpEditor/plugin/scaleimg.js","common/wx/mpEditor/plugin/cropimg.js","common/wx/mpEditor/plugin/checkText.js","tpl/tooltip.html.js","media/report.js","biz_common/utils/monitor.js"],function(t){
"use strict";
function e(t){
this.__o={
needPopup:!0,
...
imageUrl:"/cgi-bin/uploadimg2cdn?t=ajax-editor-upload-img&lang="+h.LANG+"&token="+h.TOKEN,
imagePath:"",
compressSide:1,
catchRemoteImageEnable:!0,
catcherUrl:"/cgi-bin/uploadimg2cdn?lang="+h.LANG+"&token="+h.TOKEN,
separater:"",
...
function n(t){
if(!t)return null;
for(var e=0,n=h.allEditor.length;n>e;e++)if(t===h.allEditor[e].getWindow())return h.allEditor[e];
return null;
}
t("widget/ueditor_new/themes/default/ueditor.css"),t("widget/ueditor_new/themes/default/css/ueditor.css"),
t("widget/tooltip.css");
var i=t("common/wx/Cgi.js"),o=t("tpl/mpEditor/layout.html.js"),r=t("common/wx/mpEditor/plugin/filter.js"),a=t("common/wx/mpEditor/contextmenu.js"),u=t("common/wx/mpEditor/editor_options.js"),s=t("common/wx/mpEditor/plugin/popup.js"),l=t("common/wx/mpEditor/plugin/remoteimg.js"),c=t("common/wx/mpEditor/plugin/filterPlugin.js"),d=t("common/wx/mpEditor/plugin/scaleimg.js"),f=t("common/wx/mpEditor/plugin/cropimg.js"),m=(t("common/wx/mpEditor/plugin/checkText.js"),
t("tpl/tooltip.html.js")),g=t("media/report.js"),p=t("biz_common/utils/monitor.js"),h={
allEditor:[],
...
this.__initReport(),this.__initPulginEvent(),new l(this),this.__customEventHandle(),
h.allEditor.push(this);
},
__extendPlugins:function(){
var t=this.__o;
t.plugins.push(new c),t.imgScale&&t.plugins.push(new d({
wheelScroll:t.scaleimgWheelScroll
})),t.needPopup&&t.plugins.push(new f({
...
if(n){
var o=$(n),r=t.getName();
o&&o.length>0&&o.click(function(){
e.execCommand(r),i.post({
url:"/cgi-bin/operatereddot?action=del",
data:{
bit:t.redbit
}
},function(t){
0==t.base_resp.ret&&o.children(".weui-desktop-icon-reddot").css("display","none");
});
});
}
}
...
for(var e=0,n=h.allEditor.length;n>e;e++)h.allEditor[e]===this&&h.allEditor.splice(e,1);
this.hasDestory=!0;
},
ready:function(t){
...
afterSetContent:function(t){
for(var e=this.__o.plugins,n=0,i=e.length;i>n;n++){
var o=e[n];
"function"==typeof o.afterSetContent&&o.afterSetContent(t);
}
},
...
t=t||{},t.content=this.ueditor.getContent(void 0,function(){
return!0;
...
}),t.content=r.formatStyle(t.content),t.content=r.formatRedundancyStr(t.content),
t;
},
...
var n=e("media/template_common.js"),o=e("common/wx/media/templateDialog.js"),a=e("common/wx/Tips.js");
return t.prototype={
_extend:function(e){
...
var r=e.editor;
if(r){
if(n.maxTemplateNum-t.appmsg_template_cnt<=0)return void a.err("最多只能添加%s个模版".sprintf(n.maxTemplateNum));
var m=r.getEditorData(null,"range"),s={};
for(var c in t)s[c]=t[c];
s.content=m.content||"",s.onSuccess=function(){
r.fireEvent("templateDialogClosed");
},new o(s);
}
};
},
...
})),n.push(new c),n.push(new a),n.push(new w({
container:$("#editor_insertproduct"),
can_see_product:e.can_see_product,
can_use_smart:e.can_use_smart,
can_use_product:e.can_use_product,
can_use_wxopen_link:e.can_use_wxopen_link,
redbit:128,
can_show_reddot:128&e.red_dot_flag
})),n.push(new g({
...
var _=e("common/wx/mpEditor/plugin/vote.js"),r=e("common/wx/mpEditor/plugin/card.js"),a=e("common/wx/mpEditor/plugin/emotion.js"),s=e("common/wx/mpEditor/plugin/link.js"),c=e("common/wx/mpEditor/plugin/unlink.js"),d=e("common/wx/mpEditor/plugin/audio_music.js"),u=e("common/wx/mpEditor/plugin/weapp.js"),p=e("common/wx/mpEditor/plugin/img.js"),m=e("common/wx/mpEditor/plugin/adv.js"),l=e("common/wx/mpEditor/plugin/video.js"),w=e("common/wx/mpEditor/plugin/insert_product.js"),g=e("common/wx/mpEditor/plugin/cps.js");
return{
getList:n,
...
jsCut:!0,
articleIndex:this.opt.articleIndex
});
},
_initImg:function(){
...
}),"top"==o.place&&(o.arrowCls="pos_down_center"),this.$pop=$(template.compile(s)(o)),
...
"top"==o.place&&(n=i.top-t.$pop.height()-22),"left"==o.margin?(console.log(i.top),
console.log(t.$dom.height()),t.$pop.css({
...
r.find(".js_loading").show(),x.getImagesByGroupId({
group_id:i.group,
count:i.perPage
},function(t){
if(e.dialog){
...
jsCut:!0,
articleIndex:this.options.articleIndex
}));
},
initEvent:function(){
...
a.hasClass("selected")?(p||e.converting--,a.removeClass("selected"),r=w.indexOf(e.imgArr,l),
...
e.imgArr.length>0?s.enable().addClass("btn_primary"):s.disable(),"cdn"==t.scene&&a.hasClass("selected")&&!p&&x.getCdnUrlByFileId({
file_id:l,
group_id:i.find(".js_groupitem.selected").data("groupid")
},function(i){
0==i.errcode?(e.converting--,n.data("url",i.url),r=w.indexOf(e.imgArr,l),r>=0&&(e.imgArr[r].url=i.url),
...
$(".js_imageupload").data("groupid",l),a.hide(),p.hide(),s.show(),x.getImagesByGroupId({
group_id:l,
count:t.perPage
},function(o){
...
r.hide(),s.hide(),a.show(),x.getImagesByGroupId({
group_id:i,
...
-1!=w.indexOf(t,e.file_id)&&(e.selected=1);
}),e.html(f(i)).show();
